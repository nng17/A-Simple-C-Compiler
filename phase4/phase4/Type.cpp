...
{
    return isScalar() && promote()._indirection > 0;
}
...
bool Type::isCompatible(const Type &right) const
{
    ...
    bool case1 = (temp1.isPointer()) && (temp2.isPointer() && temp2.specifier() == VOID);
    bool case2 = (temp2.isPointer()) && (temp1.isPointer() && temp1.specifier() == VOID);
